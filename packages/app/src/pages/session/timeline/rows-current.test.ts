...
describe("current session timeline rows", () => {
  ...
  test("hides internal compaction summaries from the visible timeline", () => {
    const source = [
      { id: "msg_user", type: "user", text: "найди огурцы в реестре", time: { created: 1 } },
      {
        id: "msg_compact",
        type: "compaction",
        status: "completed",
  ...
  test("hides synthetic compaction continue turns and their assistant replies", () => {
    ...
    const messages = new Map<string, typeof user | typeof assistant>([
      [user.id, user],
        ...
        [
          {
            ...
            type: "text" as const,
            text: "I'm not sure what you mean by what did we do so far.",
          },
        ],
      ],
    ])
